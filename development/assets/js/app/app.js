   ...
   var listdefault = [
      {
         ...
         icon:
            "https://contenidos.areandina.edu.co/repo/aulacanvas/1.0.0/prod/img/inicio.png",
      ...
      },
      {
         ...
         icon:
            "https://contenidos.areandina.edu.co/repo/aulacanvas/1.0.0/prod/img/evaluemonos.png",
   ...
   var list = [
      {
         ...
         icon:
            "https://contenidos.areandina.edu.co/repo/aulacanvas/1.0.0/prod/img/conceptualicemos.png",
      ...
      },
      {
         ...
         icon:
            "https://contenidos.areandina.edu.co/repo/aulacanvas/1.0.0/prod/img/alanicemos-la-situacion.png",
      ...
      },
      {
         ...
         icon:
            "https://contenidos.areandina.edu.co/repo/aulacanvas/1.0.0/prod/img/pongamos-en-practica.png",
      ...
      },
      {
         ...
         icon:
            "https://contenidos.areandina.edu.co/repo/aulacanvas/1.0.0/prod/img/propongamos.png",
