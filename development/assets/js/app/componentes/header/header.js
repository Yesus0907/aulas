	...
	return {
		...
		controller: function ($element, $scope, $sce, $rootScope, ModalService) {
			...
			$scope.tareasLoad = function () {
				$scope.tareas = 'https://areandina.instructure.com/courses/' + root.idCurso + '/assignments';
				return $scope.tareas;
			};
			...
			$scope.bibliotecaLink = function () {
				$scope.biblioteca = 'https://servicios.areandina.edu.co/services/canvas/biblioteca/index.php?username=' + root.mailUser + '&iduser=' + root.idUser;
