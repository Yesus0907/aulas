aulaApp.factory('ironVimeoService', ['$http', function ($http) {
    'use strict';
    return {
        /**
...
}]).directive('vimeo--', ['$sce', '$window', function ($sce, $window) {
    'use strict';
    return {
        restrict: 'E',
        template: '<div class="back-video box"><div class="yt-responsive"><iframe class="yt-embed" ng-src="{{$ctrl.videoUrl}}" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div></div>',
        scope: {
        },
        bindToController: {
            videoId: '=',
